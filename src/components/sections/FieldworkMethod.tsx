      ...
      >
        ...
        <div className="relative mt-16 grid gap-0 md:mt-24 md:grid-cols-3">
          ...
          <motion.div
            ...
            style={{
              backgroundImage:
                'linear-gradient(90deg, #2a3560, #5a6aaa, #8a8ec8, #a0b8dc, #7a8abc, #5a6aaa, #2a3560)',
              backgroundSize: '200% 100%',
              animation: reduceMotion ? 'none' : 'sunset-wave 12s linear infinite',
            }}
          />
            ...
            return (
              ...
              >
                ...
                <span className="absolute -top-1.5 left-0 hidden h-3 w-3 md:block" aria-hidden="true">
                  <motion.span
                    className="absolute inset-0 rounded-full bg-[#5a6aaa]/45"
                    variants={{
                  ...
                  />
                  <motion.span
                    className="absolute inset-0 rounded-full border border-[#5a6aaa]/60"
                    style={{
                      backgroundImage:
                        'linear-gradient(90deg, #2a3560, #5a6aaa, #8a8ec8, #a0b8dc, #7a8abc, #5a6aaa, #2a3560)',
                      backgroundSize: '200% 100%',
                    ...
                    variants={{
                      hidden: reduceMotion ? { scale: 1, opacity: 1 } : { scale: 0.4, opacity: 0 },
                      visible: {
                        scale: 1,
                        opacity: 1,
                  ...
                  {!reduceMotion && (
                    <motion.span
                      className="absolute inset-0 rounded-full bg-[#5a6aaa]/40"
